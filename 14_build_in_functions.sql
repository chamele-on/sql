...
select format(1231231231.12312311234, 3);

-- insert(기준 문자열, 위치, 길이, 삽입할 문자열)
select insert('내 이름은 아무개 입니다.', 7, 3, '조평훈');    
...
-- 구분자가 왼쪽부터 횟수 번쨰 나오면 그 이후의 오른쪽은 버린다.
...
select year(curdate()), month(curdate()), second(curtime());
